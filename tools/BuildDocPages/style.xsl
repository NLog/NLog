...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns="http://www.w3.org/1999/xhtml">
  ...
  <xsl:template match="type[@kind='layout-renderer']" mode="usage-example">
    <p>
      ...
      Required parameters are marked with <span class="requiredparameter">bold font</span>, other parameters are optional:
      )
    </p>
  ...
  <xsl:template match="type[@kind='target']" mode="usage-example">
    <p>
      When setting up this target in the configuration file, use the following syntax (required parameters are marked with <span class="requiredparameter">bold font</span>, other parameters are optional):
    </p>
    <div class="usage-example">
      &lt;targets&gt;<br/>
