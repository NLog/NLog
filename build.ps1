...
create-package 'NLog.Database' '"net35;net46;netstandard2.0;netstandard2.1"'
create-package 'NLog.Targets.Mail' '"net35;net46;netstandard2.0;netstandard2.1"'
create-package 'NLog.Targets.Network' '"net46;netstandard2.0;netstandard2.1"'
create-package 'NLog.Targets.Trace' '"net35;net46;netstandard2.0;netstandard2.1"'
create-package 'NLog.Targets.WebService' '"net46;netstandard2.0;netstandard2.1"'
...
create-package 'NLog.WindowsRegistry' '"net35;net46;netstandard2.0;netstandard2.1"'
...
create-package 'NLog.Targets.ConcurrentFile' '"net35;net46;netstandard2.0"'
