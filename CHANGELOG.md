...
- [#6231](https://github.com/NLog/NLog/pull/6231) Replacing ProcessInfo-LayoutRenderer with ProcessStart-LayoutRenderer. (@snakefoot)
...
- [#6118](https://github.com/NLog/NLog/pull/6118) LoggingRule - Update FinalMinLevel-property to match NLog.config. (@snakefoot)
