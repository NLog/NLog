...
- Moved old FileTarget into new nuget-packagge NLog.Targets.ConcurrentFile.
- Created new NLog.Targets.AtomicFile that supports ConcurrentWrites for NET8 on both Windows / Linux.
- Created new NLog.Targets.GZipFile that uses GZipStream for writing directly to compressed files.
